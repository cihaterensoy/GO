...
//apilerdeki json verilere karşılık gelecek structları oluşturuyoruz

type Product struct {
	Id          int     `json:"id"`
	ProductName string  `json:"productName"`
	CategoryId  int     `json:"categoryId"`
	UnitpRİCE   float64 `json:"unitPrice"`
}
...
//yeni bir ürün eklemeye yönelik bir fonksiyon yazacağız

func AddProduct() (Product, error) {
	product := Product{Id: 4, ProductName: "Telephone 2", CategoryId: 1, UnitpRİCE: 4999.99}
